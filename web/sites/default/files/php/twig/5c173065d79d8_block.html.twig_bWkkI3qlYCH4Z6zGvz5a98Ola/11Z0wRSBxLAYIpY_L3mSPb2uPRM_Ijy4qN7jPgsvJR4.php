...
<section{{ attributes.addClass(classes) }}>
  {{ title_prefix }}
  {% if label %}
    <h2{{ title_attributes.addClass('block-title') }}><span>{{ label }}</span></h2>
  {% endif %}
  {{ title_suffix }}
...
", "themes/contrib/bootstrap/templates/block/block.html.twig", "/var/www/html/addweb-ecomme/web/themes/contrib/bootstrap/templates/block/block.html.twig");
    }
}
