...
/* themes/addweb_ecomme/templates/menu/menu--footer-social-media-icon.html.twig */
class __TwigTemplate_f7fc8a6bc2d97771b297338eb5196aef1e1c791fa549352103b1719a298ca2c1 extends Twig_Template
{
    ...
    public function getmenu_links($__items__ = null, $__attributes__ = null, $__menu_level__ = null, $__classes__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                // line 22
                echo "    <ul class=\"horizontal-nav social-icon\">
    ";
                // line 23
...
$context["loop"], "last", array())) ? ("last") : ("")));
  ...
  ";
    ...
    {
        return "themes/addweb_ecomme/templates/menu/menu--footer-social-media-icon.html.twig";
    }
...
{% macro menu_links(items, attributes, menu_level, classes) %}
  {% if items %}
    <ul class=\"horizontal-nav social-icon\">
    {% for item in items %}
      {%
...
", "themes/addweb_ecomme/templates/menu/menu--footer-social-media-icon.html.twig", "/var/www/html/addweb-ecomme/web/themes/addweb_ecomme/templates/menu/menu--footer-social-media-icon.html.twig");
    }
}
