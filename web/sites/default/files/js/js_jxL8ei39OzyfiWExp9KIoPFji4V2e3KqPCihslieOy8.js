...
"use strict";!function e(r,n,t){function o(i,f){if(!n[i]){if(!r[i]){var a="function"==typeof require&&require;if(!f&&a)return a(i,!0);if(u)return u(i,!0);throw new Error("Cannot find module '"+i+"'")}var c=n[i]={exports:{}};r[i][0].call(c.exports,function(e){var n=r[i][1][e];return o(n||e)},c,c.exports,e,r,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}({1:[function(e,r,n){jQuery(document).ready(function(){jQuery(".banner .items .view-content").addClass("owl-carousel owl-theme"),jQuery(".banner .items .view-content").owlCarousel({loop:!0,nav:!1,items:1})})},{}]},{},[1]);
